...
def test_pointingUp():
    ...
    assert test_hand.isPointingUp()
    assert not test_hand.isThumbsUp()
    assert not test_hand.isBird()
    assert not test_hand.isFingerGun()
    assert not test_hand.isOkay()
    assert not test_hand.isPeace()
...
def test_isFingerGun():
    ...
    assert test_hand.isFingerGun()
    assert not test_hand.isPointingUp()
    assert not test_hand.isThumbsUp()
    assert not test_hand.isBird()
    assert not test_hand.isOkay()
    assert not test_hand.isPeace()
